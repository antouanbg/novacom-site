          ...
          <div className="grid gap-8 rounded-3xl bg-ink p-8 text-white sm:p-12 lg:grid-cols-[1.3fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 text-lg text-white/80">
                {bg
                  ? "Един от най-големите световни производители на фотоволтаични модули. Работим директно с производителя и доставяме панели и батерийни системи Suntech за бизнес и индустриални проекти."
                  : "One of the world's largest PV module manufacturers. We work directly with the manufacturer and supply Suntech modules and battery systems for commercial and industrial projects."}
              </p>
              <a
      ...
      <Section className="bg-mist">
        <Reveal>
          ...
          <p className="mt-5 max-w-3xl text-lg text-muted">
            {bg
              ? "Екипът ни преподава в ТУ-София по интелигентни мрежи и системи за ВЕИ и стои зад публикации в IEEE Xplore и четири регистрирани полезни модела."
              : "Our team teaches smart grids and renewable energy systems at the Technical University of Sofia and stands behind IEEE Xplore publications and four registered utility models."}
          </p>
        </Reveal>
      </Section>
      <CTA lang={lang} />
