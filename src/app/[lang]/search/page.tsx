  ...
  return (
    <Section>
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="[overflow-wrap:normal] [hyphens:manual] mt-2 text-[clamp(1.25rem,6.5vw,2.25rem)] font-extrabold leading-[1.12]">{bg ? "Какво търсите?" : "What are you looking for?"}</h1>
