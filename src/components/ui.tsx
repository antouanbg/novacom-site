...
export function H2({ children, className = "" }: { children: ReactNode; className?: string }) {
  return <h2 className={`[overflow-wrap:normal] [hyphens:manual] text-[clamp(1.2rem,5.8vw,44px)] font-extrabold leading-tight ${className}`}>{children}</h2>;
}
    ...
    <section className="relative isolate overflow-hidden bg-ink text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28">
        <Reveal>
          ...
          <h1 className="[overflow-wrap:normal] [hyphens:manual] max-w-3xl text-[clamp(1.25rem,7vw,3.75rem)] font-extrabold leading-[1.12]">{title}</h1>
